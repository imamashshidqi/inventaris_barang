<footer class="bg-white rounded-lg shadow sm:flex sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8 antialiased">
    <p class="mb-4 text-sm text-center text-gray-500 sm:mb-0">
        &copy; 2025 <a href="#" class="hover:underline" target="_blank">Inventaris.com</a> Build with
        ❤️ by <a href="instagram.com/imam_ashshidqi" class="hover:underline" target="_blank">Salma, Nadya & Imam</a>. All
        rights reserved.
    </p>
